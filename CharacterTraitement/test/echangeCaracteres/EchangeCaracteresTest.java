...
public class EchangeCaracteresTest {
    ...
    {
        assertEquals("TENRANI",echange2DerniersCar("TENRAIN"));
    }    
    
    @Test
    public void testEchangeChaineAvec1Car()
    {
        assertEquals("A",echange2DerniersCar("A"));
    }     

    @Test
    public void testEchangeChaineAvecCarVide()
    {
        assertEquals("",echange2DerniersCar(""));
    }     
